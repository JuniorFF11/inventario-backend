...
/***/ function(module, exports, __webpack_require__) {
	...
	var page = __webpack_require__(340);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var jQuery = __webpack_require__(324);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(process) {  /* globals require, module */
	  ...
	  var pathtoRegexp = __webpack_require__(341);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var el = __webpack_require__(344);
	var empty = __webpack_require__(372);
	var page = __webpack_require__(340);
	var loader = __webpack_require__(373);

	page('/login', loader, function (ctx, next) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _templateObject = _taggedTemplateLiteral(['<div class="col-xs-12 col-md-6 col-md-offset-3">\n    <div class="login-box">\n  <div class="login-logo">\n    <a href="/login"><img class="login-logo" src="/logo.jpg"/></a>\n  </div>\n  <div class="login-box-body">\n    <p class="login-box-msg">Iniciar Sesion</p>\n\n    <form>\n      <div class="row">\n        <div class="col-xs-12">\n          <div class="form-group has-feedback">\n            <input type="text" id="usuario" name="usuario" class="form-control" placeholder="Usuario">\n            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>\n          </div>\n          <div class="form-group has-feedback">\n            <input type="password" id="contrasena" name="contrasena" class="form-control" placeholder="Contrase\xF1a">\n            <span class="glyphicon glyphicon-lock form-control-feedback"></span>\n          </div>\n               \n        </div>\n        <div class="col-xs-4 pull-right">\n          <button onclick=', ' class="btn btn-primary btn-block btn-flat">Entrar</button>\n        </div>\n      </div>\n    </form>\n    \n  </div>\n</div>\n  </div>'], ['<div class="col-xs-12 col-md-6 col-md-offset-3">\n    <div class="login-box">\n  <div class="login-logo">\n    <a href="/login"><img class="login-logo" src="/logo.jpg"/></a>\n  </div>\n  <div class="login-box-body">\n    <p class="login-box-msg">Iniciar Sesion</p>\n\n    <form>\n      <div class="row">\n        <div class="col-xs-12">\n          <div class="form-group has-feedback">\n            <input type="text" id="usuario" name="usuario" class="form-control" placeholder="Usuario">\n            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>\n          </div>\n          <div class="form-group has-feedback">\n            <input type="password" id="contrasena" name="contrasena" class="form-control" placeholder="Contrase\xF1a">\n            <span class="glyphicon glyphicon-lock form-control-feedback"></span>\n          </div>\n               \n        </div>\n        <div class="col-xs-4 pull-right">\n          <button onclick=', ' class="btn btn-primary btn-block btn-flat">Entrar</button>\n        </div>\n      </div>\n    </form>\n    \n  </div>\n</div>\n  </div>']);

	function _taggedTemplateLiteral(strings, raw) { return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }

	var yo = __webpack_require__(345);
	var page = __webpack_require__(340);
	var swal = __webpack_require__(355);
	var request = __webpack_require__(364);

	var el = renderLogin();
	function renderLogin() {
	  var el = yo(_templateObject, logIn);
	  return el;
	}
	...
	function logIn(e) {
	  ...
	  request.get('/api/usuario/buscar').query({ usuario: { usuario: usuario, contrasena: contrasena } }).end(function (err, resp) {
	    if (err) {
	      return swal('Usuario o contrasena incorrecto.');
	    }
	    var usuario = JSON.parse(resp.text);
	    signToken(usuario);
	  });
	}

	function signToken(usuario) {
	  request.post('/api/token/sign').send({ datos: usuario }).end(function (err, resp) {
	    if (err) {
	      console.log(err);
	      swal('Error', 'Ha ocurrido un error en el inicio de sesion', 'Error');
	    }
	    var token = JSON.parse(resp.text);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bel = __webpack_require__(346) // turns template tag into DOM elements
	var morphdom = __webpack_require__(353) // efficiently diffs + morphs two DOM elements
	var defaultEvents = __webpack_require__(354) // default events to be copied when dom elements update
...
/***/ function(module, exports, __webpack_require__) {
	...
	var document = __webpack_require__(347)
	var hyperx = __webpack_require__(349)
	var onload = __webpack_require__(351)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var minDoc = __webpack_require__(348);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var attrToProp = __webpack_require__(350)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var document = __webpack_require__(347)
	var window = __webpack_require__(352)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _hasClass$addClass$removeClass$escapeHtml$_show$show$_hide$hide$isDescendant$getTopMargin$fadeIn$fadeOut$fireClick$stopEventPropagation = __webpack_require__(356);

	/*
	 * Handy utilities
	 */

	var _extend$hexToRgb$isIE8$logStr$colorLuminance = __webpack_require__(357);

	/*
	 *  Handle sweetAlert's DOM elements
	 */

	var _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition = __webpack_require__(358);

	// Handle button events and keyboard events

	var _handleButton$handleConfirm$handleCancel = __webpack_require__(361);

	var _handleKeyDown = __webpack_require__(362);

	var _handleKeyDown2 = _interopRequireWildcard(_handleKeyDown);

	// Default values

	var _defaultParams = __webpack_require__(359);

	var _defaultParams2 = _interopRequireWildcard(_defaultParams);

	var _setParameters = __webpack_require__(363);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _hexToRgb = __webpack_require__(357);

	var _removeClass$getTopMargin$fadeIn$show$addClass = __webpack_require__(356);
	...
	var _injectedHTML = __webpack_require__(360);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _colorLuminance = __webpack_require__(357);

	var _getModal = __webpack_require__(358);

	var _hasClass$isDescendant = __webpack_require__(356);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stopEventPropagation$fireClick = __webpack_require__(356);

	var _setFocusStyle = __webpack_require__(358);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isIE8 = __webpack_require__(357);

	var _getModal$getInput$setFocusStyle = __webpack_require__(358);

	var _hasClass$addClass$removeClass$escapeHtml$_show$show$_hide$hide = __webpack_require__(356);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Emitter = __webpack_require__(365);
	var RequestBase = __webpack_require__(366);
	var isObject = __webpack_require__(367);
	var isFunction = __webpack_require__(368);
	var ResponseBase = __webpack_require__(369);
	var shouldRetry = __webpack_require__(371);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var page = __webpack_require__(340);
	var autorizacion = __webpack_require__(375);
	var loader = __webpack_require__(373);
	...
	page('/', autorizacion(1), loader, menu, navbar, function (ctx, next) {});
	...
	module.exports = function (nivel) {
	  return function (ctx, next) {
	    if (window.localStorage.tokenApp) {
	      ...
	      request.get('/api/token/validate').set('Authorization', window.localStorage.tokenApp).end(function (err, resp) {
	        if (err) {
	          console.log(err);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _navbar = __webpack_require__(377);
	var empty = __webpack_require__(372);
	var menu = __webpack_require__(378);

	module.exports = {
	  menu: menu,
	  navbar: function navbar(ctx, next) {
	    var header = document.getElementById('header');
	    var el = _navbar(ctx.params.menu);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _templateObject = _taggedTemplateLiteral(['<nav class="navbar navbar-inverse">\n  <div class="container-fluid">\n    \n    <div class="navbar-header">\n      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">\n        <span class="sr-only">Toggle navigation</span>\n        <span class="icon-bar"></span>\n        <span class="icon-bar"></span>\n        <span class="icon-bar"></span>\n      </button>\n      <a class="navbar-brand" href="/">Inventario</a>\n    </div>\n\n    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">\n      <ul class="nav navbar-nav">\n         ', '\n      </ul>\n      <ul class="nav navbar-nav navbar-right">\n        <li class="dropdown">\n          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user-circle-o user-option" aria-hidden="true"> </i> ', '</a>\n          <ul class="dropdown-menu">\n            <li><a onclick=', '>Cerrar Sesion</a></li>  \n          </ul>\n        </li>\n      </ul>\n    </div>\n  </div>\n</nav>'], ['<nav class="navbar navbar-inverse">\n  <div class="container-fluid">\n    \n    <div class="navbar-header">\n      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">\n        <span class="sr-only">Toggle navigation</span>\n        <span class="icon-bar"></span>\n        <span class="icon-bar"></span>\n        <span class="icon-bar"></span>\n      </button>\n      <a class="navbar-brand" href="/">Inventario</a>\n    </div>\n\n    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">\n      <ul class="nav navbar-nav">\n         ', '\n      </ul>\n      <ul class="nav navbar-nav navbar-right">\n        <li class="dropdown">\n          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user-circle-o user-option" aria-hidden="true"> </i> ', '</a>\n          <ul class="dropdown-menu">\n            <li><a onclick=', '>Cerrar Sesion</a></li>  \n          </ul>\n        </li>\n      </ul>\n    </div>\n  </div>\n</nav>']),
	    _templateObject2 = _taggedTemplateLiteral([' \n              <li class="dropdown"> \n              <a href=', ' class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">', ' <i class="fa fa-chevron-circle-down" aria-hidden="true"> </i></a>\n              <ul class="dropdown-menu">\n                  ', '\n              </ul>\n              </li>\n              '], [' \n              <li class="dropdown"> \n              <a href=', ' class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">', ' <i class="fa fa-chevron-circle-down" aria-hidden="true"> </i></a>\n              <ul class="dropdown-menu">\n                  ', '\n              </ul>\n              </li>\n              ']),
	    _templateObject3 = _taggedTemplateLiteral(['<li  class="text-center"><a href="', '"> ', '</a></li>'], ['<li  class="text-center"><a href="', '"> ', '</a></li>']);
	...
	function getNavbar(menu, submenu) {
	  var elNavbar = yo(_templateObject, menu.map(function renderMenu(element) {
	    if (element.padreId === '0') {
	      var el = yo(_templateObject2, element.link, element.descripcion, menu.map(function (submenu) {
	        if (element.menuId === submenu.padreId) return yo(_templateObject3, submenu.link, submenu.descripcion);
	      }));
	      return el;
	    }
	  }), window.localStorage.usuario, logOut);
	  return elNavbar;
	}
	function logOut() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function menu(cxt, next) {
	  request.get('/api/token/validate').set('Authorization', window.localStorage.tokenApp).end(function (err, resp) {
	    if (err) return err;
	    var respuesta = JSON.parse(resp.text);
	    request.get('/api/menu/buscar').query({ menues: { usuarioNivel: { $lte: respuesta.token.tipoUsuario.nivelUsuario } } }).end(function (err, res) {
	      if (err) console.log(err);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require2 = __webpack_require__(381),
	    tipoUsuario = _require2.tipoUsuario;

	page('/usuario/crear', autorizacion(4), loader, menu, navbar, tipoUsuario, function (ctx, next) {
	  var container = document.getElementById('main-container');
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (tipoUsuario) {
	  var el = yo(_templateObject, tipoUsuario.map(function (tipo) {
	    return yo(_templateObject2, tipo.tipoUsuarioId, tipo.descripcion);
	  }), crearUsuario);
	  return el;
	};
	...
	function crearUsuario(e) {
	  e.preventDefault();
	  var nombre = document.getElementById('crearNombre').value;
	  var usuario = document.getElementById('crearUsuario').value;
	  var contrasena = document.getElementById('crearPassword').value;
	  var apellido = document.getElementById('crearApellido').value;
	  var tipoUsuarioId = document.getElementById('crearTipoUsuario').value;
	  loader(null, function () {});

	  request.post('/api/usuario/crear').send({
	    usuario: {
	      nombre: nombre,
	      usuario: usuario,
...
/***/ function(module, exports, __webpack_require__) {
	...
	function tipoUsuario(ctx, next) {
	  request.get('/api/usuario/tipousuario/ver').end(function (err, resp) {
	    if (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _templateObject = _taggedTemplateLiteral(['<div class="container" id="usuario-info"></div>'], ['<div class="container" id="usuario-info"></div>']);
	...
	var yo = __webpack_require__(345);
	page('/usuario/modificar', autorizacion(4), loader, menu, navbar, tipoUsuario, usuarios, function (ctx, next) {
	  var container = document.getElementById('main-container');
	  empty(container).appendChild(template(ctx.params.usuarios, ctx.params.tipoUsuario));
	  container.appendChild(yo(_templateObject));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _templateObject = _taggedTemplateLiteral(['\n  <div class="container">\n    <form>\n      <div class="row">\n        <div class="col-xs-12 col-md-6">\n          <div class ="form-group">\n            <label for="nombre">Empleado</label>\n            <select class="form-control" onchange=', ' id="modificarUsuario">\n              <option value="0">Seleccionar Usuario</option>\n              ', '\n            </select>\n          </div> \n        </div>\n        <div class="usuario-container"></div>\n      \n    </form>\n  </div>\n'], ['\n  <div class="container">\n    <form>\n      <div class="row">\n        <div class="col-xs-12 col-md-6">\n          <div class ="form-group">\n            <label for="nombre">Empleado</label>\n            <select class="form-control" onchange=', ' id="modificarUsuario">\n              <option value="0">Seleccionar Usuario</option>\n              ', '\n            </select>\n          </div> \n        </div>\n        <div class="usuario-container"></div>\n      \n    </form>\n  </div>\n']),
	    _templateObject2 = _taggedTemplateLiteral(['<option value=', '>', ' ', '</option>'], ['<option value=', '>', ' ', '</option>']),
	    _templateObject3 = _taggedTemplateLiteral(['<option value=', ' selected="selected">', '</option>'], ['<option value=', ' selected="selected">', '</option>']),
	...
	module.exports = function (usuarios, tipoUsuario) {
	  var el = yo(_templateObject, cargarUsuario, usuarios.map(function (usuario) {
	    return yo(_templateObject2, usuario.usuarioId, usuario.nombre, usuario.apellido);
	  }));
	  function cargarUsuario() {
	    var usuarioInfoContainer = document.getElementById('usuario-info');
	    var usuarioSeleccionado = document.getElementById('modificarUsuario').value;
	    var usuario = void 0;
	    ...
	    var tipoUsuarioList = tipoUsuario.map(function (tipo) {
	      if (usuario.tipoUsuarioId === tipo.tipoUsuarioId) {
	        return yo(_templateObject3, tipo.tipoUsuarioId, tipo.descripcion);
	      } else {
	        return yo(_templateObject4, tipo.tipoUsuarioId, tipo.descripcion);
	      }
	    });

	    var usuarioEl = yo(_templateObject5, usuario.usuario, usuario.nombre, usuario.apellido, tipoUsuarioList.map(function (tipo) {
	      return tipo;
	    }), modificarUsuario);
	    console.log(usuario);
	  ...
	  function procesoModificacion() {
	    var usuarioId = document.getElementById('modificarUsuario').value;
	    if (usuarioId === '0') return swal('Error', 'Debe elegir un usuario a modificar', 'error');

	    var usuario = document.getElementById('usuario').value;
	    var nombre = document.getElementById('nombre').value;
	    var apellido = document.getElementById('apellido').value;
	    var tipoUsuarioId = document.getElementById('tipoUsuario').value;
	    var estado = document.getElementById('estadoA').checked;
	    estado ? estado = 'A' : estado = 'E';
	    request.put('/api/usuario/modificar').send({
	      usuarioViejo: { usuarioId: usuarioId },
	      usuarioNuevo: {
	        usuario: usuario,
	        nombre: nombre,
	        apellido: apellido,
...
/***/ function(module, exports, __webpack_require__) {
	...
	function buscarUsuarios(ctx, next) {
	  request('/api/usuario/buscarusuarios').end(function (err, resp) {
	    if (err) {
	      ctx.params.usuarios = [];
	      next();
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var empty = __webpack_require__(372);
	page('/configuracion/usuario/eliminar', autorizacion(4), loader, menu, navbar, function (ctx, next) {
	  var container = document.getElementById('main-container');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require2 = __webpack_require__(388),
	    buscarUsuarios = _require2.buscarUsuarios;

	var template = __webpack_require__(389);
	var empty = __webpack_require__(372);
	page('/usuario/ver', autorizacion(4), loader, menu, navbar, buscarUsuarios, function (ctx, next) {
	  var container = document.getElementById('main-container');
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (usuarios) {
	  var el = yo(_templateObject, usuarios.map(function (usuario) {
	    return yo(_templateObject2, usuario.nombre, usuario.apellido, usuario.tipoUsuario.descripcion);
	  }));
	  return el;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var swal = __webpack_require__(355);
	var request = __webpack_require__(364);
	page('/almacen/crear', autorizacion(3), loader, menu, navbar, function (ctx, next) {
	  swal({
	    title: 'Crear Almacen',
	    ...
	    request.post('/api/almacen/crear').send({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require2 = __webpack_require__(392),
	    buscarAlmacenes = _require2.buscarAlmacenes;

	var template = __webpack_require__(393);
	var empty = __webpack_require__(372);
	page('/almacen/ver', autorizacion(1), loader, menu, navbar, buscarAlmacenes, function (ctx, next) {
	  var container = document.getElementById('main-container');
...
/***/ function(module, exports, __webpack_require__) {
	...
	function buscarAlmacenes(ctx, next) {
	  request('/api/almacen/buscarAlmacenes').end(function (err, resp) {
	    if (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (almacenes) {
	  var el = yo(_templateObject, almacenes.map(function (almacen) {
	    return yo(_templateObject2, almacen.almacenId, almacen.descripcion, almacen.estado);
	  }));
	  return el;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _templateObject = _taggedTemplateLiteral(['<div class="container" id="almacen-info"></div>'], ['<div class="container" id="almacen-info"></div>']);
	...
	page('/almacen/modificar', autorizacion(3), loader, menu, navbar, buscarAlmacenes, function (ctx, next) {
	  var container = document.getElementById('main-container');
	  empty(container).appendChild(template(ctx.params.almacenes));
	  container.appendChild(yo(_templateObject));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var page = __webpack_require__(340);
	module.exports = function (almacenes) {
	  var el = yo(_templateObject, cargarAlmacen, almacenes.map(function (almacen) {
	    return yo(_templateObject2, almacen.almacenId, almacen.descripcion);
	  }));
	  function cargarAlmacen() {
	    var almacenSeleccionado = document.getElementById('modificarAlmacen').value;
	    var almacenContainer = document.getElementById('almacen-info');
	    ...
	    try {
	      for (var _iterator = almacenes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	        var a = _step.value;
	    ...
	    var almacenEl = yo(_templateObject3, almacen.descripcion, modificarAlmacen);
	  ...
	  function modificarAlmacen(e) {
	    ...
	    function procesoModificacion() {
	      var almacen = document.getElementById('modificarAlmacen').value;
	      ...
	      request.put('/api/almacen/modificar').send({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require2 = __webpack_require__(398),
	    buscarFuncionalidades = _require2.buscarFuncionalidades,
	    buscarTipoUsuarios = _require2.buscarTipoUsuarios;

	var template = __webpack_require__(399);
	var empty = __webpack_require__(372);
	page('/permisos/ver', autorizacion(4), loader, menu, navbar, buscarFuncionalidades, buscarTipoUsuarios, function (ctx, next) {
	  var container = document.getElementById('main-container');
...
/***/ function(module, exports, __webpack_require__) {
	...
	function buscarFuncionalidades(cxt, next) {
	  request.get('/api/menu/buscar').query({ menues: { padreId: { $ne: '0' } } }).end(function (err, res) {
	    if (err) console.log(err);
	...
	module.exports = {
	  buscarTipoUsuarios: buscarTipoUsuarios,
	  buscarFuncionalidades: buscarFuncionalidades
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _templateObject = _taggedTemplateLiteral(['<div class="container">\n    <div class="col-xs-12 col-md-12 ver-almacen-titulo">\n      <h3>Permisos</h3>\n    </div>\n      ', '\n    </div>\n  '], ['<div class="container">\n    <div class="col-xs-12 col-md-12 ver-almacen-titulo">\n      <h3>Permisos</h3>\n    </div>\n      ', '\n    </div>\n  ']),
	    _templateObject2 = _taggedTemplateLiteral(['\n          <table class="table table-hover table-bordered table-striped">\n            <thead>\n              <tr>\n                <th class="ver-almacen-titulo">', '</th>\n              </tr>\n            </thead>\n            <tbody>\n              ', '\n            </tbody>\n          </table>\n        '], ['\n          <table class="table table-hover table-bordered table-striped">\n            <thead>\n              <tr>\n                <th class="ver-almacen-titulo">', '</th>\n              </tr>\n            </thead>\n            <tbody>\n              ', '\n            </tbody>\n          </table>\n        ']),
	    _templateObject3 = _taggedTemplateLiteral(['\n                  <tr>\n                      <td>', '</td>\n                  </tr>'], ['\n                  <tr>\n                      <td>', '</td>\n                  </tr>']);
	...
	module.exports = function (tipoUsuarios, funcionalidades) {
	  var el = yo(_templateObject, tipoUsuarios.map(function (tipo) {
	    return yo(_templateObject2, tipo.descripcion, funcionalidades.map(function (funcionalidad) {
	      if (tipo.nivelUsuario >= funcionalidad.usuarioNivel) {
	        return yo(_templateObject3, funcionalidad.descripcion);
	      }
	    }));
	  }));
	  return el;
...
/***/ function(module, exports, __webpack_require__) {
	...
	page('/permisos/modificar', autorizacion(4), loader, menu, navbar, function (ctx, next) {
	  var container = document.getElementById('main-container');
	  empty(container).appendChild(template());
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _templateObject = _taggedTemplateLiteral(['<div class="container">\n    <div class="row">\n      <ul class="nav nav-tabs">\n        <li class="active"><a href="/permisos/agregar"><i class="fa fa-plus" aria-hidden="true"></i> Agregar Permisos</a></li>\n        <li><a href="/permisos/quitar"><i class="fa fa-times" aria-hidden="true"></i> Quitar permisos</a></li>\n      </ul>\n    </div>\n    <div class="row" id="permisos-container"></div>\n  </div>'], ['<div class="container">\n    <div class="row">\n      <ul class="nav nav-tabs">\n        <li class="active"><a href="/permisos/agregar"><i class="fa fa-plus" aria-hidden="true"></i> Agregar Permisos</a></li>\n        <li><a href="/permisos/quitar"><i class="fa fa-times" aria-hidden="true"></i> Quitar permisos</a></li>\n      </ul>\n    </div>\n    <div class="row" id="permisos-container"></div>\n  </div>']),
	    _templateObject2 = _taggedTemplateLiteral(['\n    <div  id="agregar-permiso-container">\n      <div class="row">\n        <div id="rol-container" class="container col-xs-12 col-md-6"></div>\n        <div class="col-xs-12 col-md-6 container" id="manejo-container"></div>\n      </div>\n    </div>\n    '], ['\n    <div  id="agregar-permiso-container">\n      <div class="row">\n        <div id="rol-container" class="container col-xs-12 col-md-6"></div>\n        <div class="col-xs-12 col-md-6 container" id="manejo-container"></div>\n      </div>\n    </div>\n    ']);
	...
	page('/permisos/agregar', autorizacion(4), menu, navbar, tipoUsuario, function (ctx, next) {
	  var appContainer = document.getElementById('main-container');
	  empty(appContainer).appendChild(yo(_templateObject));
	  var container = document.getElementById('permisos-container');
	  empty(container).appendChild(yo(_templateObject2));
	  var rolContainer = document.getElementById('rol-container');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var empty = __webpack_require__(372);
	module.exports = function (tipoUsuario) {
	  var el = yo(_templateObject, cargarPermisos, tipoUsuario.map(function (tipo) {
	    return yo(_templateObject2, tipo.nivelUsuario, tipo.descripcion);
	  }));
	  function cargarPermisos() {
	    buscarPermisos().then(function (permisos) {
	      ...
	      empty(container).appendChild(yo(_templateObject3, permisos.map(function (permiso) {
	        return yo(_templateObject2, permiso.menuId, permiso.descripcion);
	      }), agregarPermiso));
	    }).catch(function (e) {
	      return swal('Error', 'Ha ocurrido un error cargando los permisos de este rol', 'error');
	    });
	  ...
	  function agregarPermiso(e) {
	    e.preventDefault();
	    request.put('/api/menu/modificar').send({
	  ...
	  function buscarPermisos() {
	    return new Promise(function (resolve, reject) {
	      var nivel = document.getElementById('tipoUsuario').value;
	      request.get('/api/menu/buscar').query({
	        menues: {
	          padreId: { $ne: '0' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	page('/permisos/quitar', autorizacion(4), menu, navbar, tipoUsuario, function (ctx, next) {
	  var appContainer = document.getElementById('main-container');
	  empty(appContainer).appendChild(yo(_templateObject));
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (tipoUsuario) {
	  ...
	  function agregarPermiso(e) {
	    e.preventDefault();
	    var nuevoNivel = document.getElementById('tipoUsuario').value === 4 ? 4 : parseInt(document.getElementById('tipoUsuario').value) + 1;
	    request.put('/api/menu/modificar').send({
	      menu: { menuId: document.getElementById('permisos').value },
	      nuevo: { usuarioNivel: nuevoNivel }
	    }).end(function (err, resp) {
	      if (err) return swal('Error', 'Ha ocurrido un error actualizando el permiso', 'error');
	      cargarPermisos();
	      swal('Exito', 'El permiso ha sido actualizado correctamente', 'success');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var empty = __webpack_require__(372);
	page('/proveedor/crear', autorizacion(3), loader, menu, navbar, function (ctx, next) {
	  var container = document.getElementById('main-container');
	  empty(container).appendChild(template());
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function () {
	  var el = yo(_templateObject, crearProveedor);
	  return el;
	};
	...
	function crearProveedor(e) {
	  e.preventDefault();
	  var nombre = document.getElementById('crearNombre').value;
	  var telefono = document.getElementById('crearTelefono').value;
	  var direccion = document.getElementById('crearDireccion').value;
	  var contacto = document.getElementById('crearContacto').value;
	  loader(null, function () {});

	  request.post('/api/proveedor/crear').send({
	    proveedor: {
	      nombre: nombre,
	      telefono: telefono,
	      direccion: direccion,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require2 = __webpack_require__(411),
	    buscarProveedores = _require2.buscarProveedores;

	var template = __webpack_require__(412);
	var empty = __webpack_require__(372);
	page('/proveedor/ver', autorizacion(2), loader, menu, navbar, buscarProveedores, function (ctx, next) {
	  var container = document.getElementById('main-container');
...
/***/ function(module, exports, __webpack_require__) {
	...
	function buscarProveedores(ctx, next) {
	  request('/api/proveedor/buscarproveedores').end(function (err, resp) {
	    if (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (proveedores) {
	  var el = yo(_templateObject, proveedores.map(function (proveedor) {
	    return yo(_templateObject2, proveedor.nombre, proveedor.telefono, proveedor.contacto, proveedor.direccion);
	  }));
	  return el;
	};
